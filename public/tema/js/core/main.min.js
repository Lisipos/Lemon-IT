...
!(function (e, t) {
  ...
  function Re(e, t) {
    t.left && g(e, { borderLeftWidth: 1, marginLeft: t.left - 1 }),
      t.right && g(e, { borderRightWidth: 1, marginRight: t.right - 1 });
  }
  function Ie(e) {
    g(e, {
      marginLeft: "",
  ...
  function Ke(e, t) {
    ...
    return (
      e.start && ((n = X(e.start)), r && r <= n && (r = A(n, 1))),
      { start: n, end: r }
    );
  }
  function Qe(e) {
  ...
  function $e(e, t, n, r) {
    return "year" === r
      ? ue(n.diffWholeYears(e, t), "year")
      : "month" === r
      ? ue(n.diffWholeMonths(e, t), "month")
      : Y(e, t);
  }
  function et(e, t) {
    function n() {
      ...
      if (s) {
        ...
        return (
          ...
          null == u &&
            ...
            (u = !1),
          ki(i, a),
          { allDay: u, duration: s.duration, typeData: s.typeData, typeId: o }
        );
      }
    }
    return null;
  ...
  function Et(e, t) {
    var n,
      ...
      i = [],
      o = t.start;
    for (e.sort(St), n = 0; n < e.length; n++)
      (r = e[n]),
  ...
  function xt(e, t, n, r, i) {
    return (
      ...
      r.omitCommas && (e = e.replace(Hi, "").trim()),
      r.omitZeroMinute && (e = e.replace(":00", "")),
      !1 === r.meridiem
        ? (e = e.replace(Pi, "").trim())
        : "narrow" === r.meridiem
        ? (e = e.replace(Pi, function (e, t) {
  ...
  function Vt(e, t) {
    return "object" == typeof e && e
      ? ("string" == typeof t && (e = ki({ separator: t }, e)), new Ui(e))
      : "string" == typeof e
      ? new Li(e, t)
      : "function" == typeof e
      ? new Ai(e)
  ...
  function Ft(e) {
    return (
      Fe(e.getUTCHours(), 2) +
      ":" +
      Fe(e.getUTCMinutes(), 2) +
      ":" +
      Fe(e.getUTCSeconds(), 2)
    );
  }
  function Wt(e, t) {
    void 0 === t && (t = !1);
  ...
  function Yt(e, t, n, r) {
    ...
    for (var c in e.defs) {
      ...
      "inverse-background" === d.rendering &&
        (d.groupId
          ? ((i[d.groupId] = []), a[d.groupId] || (a[d.groupId] = d))
          : (o[c] = []));
    }
      ...
      y &&
        ("inverse-background" === d.rendering
          ? d.groupId
            ? i[d.groupId].push(y)
            : o[p.defId].push(y)
          : ("background" === d.rendering ? s : u).push({
              def: d,
              ui: h,
              instance: p,
              range: y,
  ...
  function en(e, t, n, r, i) {
    ...
    null == o.hasEnd &&
      t.durationEditable &&
      tn(t.startEditable ? n.startDelta : null, n.endDelta || null) &&
      (o.hasEnd = !0);
    var a = ki({}, e, o, { ui: ki({}, e.ui, o.ui) });
    n.extendedProps &&
  ...
  function tn(e, t) {
    return (
      e && !De(e) && (e = null),
      t && !De(t) && (t = null),
      !(!e && !t) && (Boolean(e) !== Boolean(t) || !fe(e, t))
    );
  }
  function nn(e, t, n, r, i) {
    ...
    return (
      ...
      s
        ...
        : !r.endDelta ||
          (!n.durationEditable &&
            tn(n.startEditable ? r.startDelta : null, r.endDelta)) ||
          (u.range = {
            start: u.range.start,
            end: o.add(u.range.end, r.endDelta),
          }),
      t.allDay && (u.range = { start: X(u.range.start), end: X(u.range.end) }),
  ...
  function hn(e, t, n, r) {
    return (
      void 0 === n && (n = {}),
      !(e.eventDrag && !vn(e, t, n, r)) && !(e.dateSelection && !gn(e, t, n, r))
    );
  }
  function vn(e, t, n, r) {
    var i = e.eventDrag,
      ...
      a = o.defs,
      s = o.instances,
      u = Kt(a, i.isEvent ? e.eventUiBases : { "": t.selectionConfig });
    r && (u = ot(u, r));
    ...
    for (var p in s) {
      ...
      for (var b = 0, D = g.allows; b < D.length; b++) {
        var T = D[b],
          w = ki({}, n, { range: h.range, allDay: y.allDay }),
          R = e.eventStore.defs[y.defId],
          I = e.eventStore.instances[p],
          C = void 0;
        if (
          ((C = R ? new Bi(t, R, I) : new Bi(t, y)),
          !T(t.buildDateSpanApi(w), C))
        )
          return !1;
      }
    }
  ...
  function gn(e, t, n, r) {
    var i = e.eventStore,
      ...
      u = s.range,
      l = t.selectionConfig;
    if ((r && (l = r(l)), !yn(l.constraints, u, i, e.businessHours, t)))
      return !1;
  ...
  function _n(e, t, n, r, i) {
    ...
    return (
      (a.extendedProps = ki(o, a.extendedProps || {})),
  ...
  function Hn(e, t, n, r, i) {
    ...
    return (
      ...
      u && l && (l = X(l)),
      a && ((d = a.marker), u && (d = X(d)), l && d <= l && (d = null)),
      d
        ? (c = !0)
        : i ||
  ...
  function An(e, t, n) {
    ...
    function i() {
      (a && Mt(a, arguments)) ||
        (r(), (o = this), (a = arguments), e.apply(this, arguments));
    }
    void 0 === n && (n = []);
    var o,
      a,
  ...
  function Bn(e, t, n) {
    ...
    if (n > 0) {
      ...
      for (var r = 0; r < e.length; r++) if (!Vn(e[r], t[r], n - 1)) return !1;
      return !0;
    }
    return !1;
  }
  ...
  function Yn(e, t, n, r) {
    ...
    return (
      ...
      (r = r || ""),
      !a && e.opt("navLinks")
        ? "<a" + n + ' data-goto="' + Dn(JSON.stringify(s)) + '">' + r + "</a>"
        : "<span" + n + ">" + r + "</span>"
    );
  }
  function qn(e) {
  ...
  function or(e, t, n, r) {
    for (var i = e ? at(e) : null, o = X(n.start), a = n.end, s = []; o < a; ) {
      var u = void 0;
      (i && !i[o.getUTCDay()]) || ((u = t ? r.add(o, t) : o), s.push(u)),
        (o = A(o, 1));
    }
    return s;
  }
  function ar(e, t) {
    for (
      var n = st(t.state.eventSources), r = [], i = 0, o = e;
      i < o.length;
      i++
    ) {
  ...
  function Sr(e, t, n, r) {
    switch (t.type) {
      ...
      case "CHANGE_TIMEZONE":
        return Rr(
          e,
          t.sourceIds ? at(t.sourceIds) : Mr(e, r),
  ...
  function Ir(e, t, n) {
    ...
    return (
      ...
      ki({}, e, { isFetching: !0, latestFetchId: i })
    );
  }
  function Cr(e, t, n, r) {
    var i,
    ...
    return o && n === o.latestFetchId
      ? ki(
          {},
          e,
          ((i = {}), (i[t] = ki({}, o, { isFetching: !1, fetchRange: r })), i)
        )
      : e;
  }
  function Mr(e, t) {
  ...
  function kr(e, t) {
    return (
      Dt(e.activeRange, t.activeRange) &&
      Dt(e.validRange, t.validRange) &&
      fe(e.minTime, t.minTime) &&
      fe(e.maxTime, t.maxTime)
    );
  }
  function Or(e, t, n) {
    for (
      var r = _r(e.viewType, t),
        i = Pr(e.dateProfile, t, e.currentDate, r, n),
        o = Sr(e.eventSources, t, i, n),
        a = ki({}, e, {
          viewType: r,
          dateProfile: i,
  ...
  function Pr(e, t, n, r, i) {
    ...
    switch (t.type) {
      ...
      case "NEXT":
        ...
        break;
      case "SET_DATE":
        (e.activeRange && Rt(e.currentRange, t.dateMarker)) ||
  ...
  function Hr(e, t, n) {
    switch (t.type) {
      ...
      case "SET_VIEW_TYPE":
        ...
        return n.activeRange && !Rt(n.activeRange, r)
  ...
  function jr(e, t, n) {
    var r = _n({ editable: !1 }, "", e.allDay, !0, n);
    return {
      def: r,
      ui: Qt(r, t),
  ...
  function ei(e, t) {
    ...
    return (
      ...
      this.dateEnv.formatRange(
        n.start,
        n.end,
        Vt(t.titleFormat || ti(e), t.titleRangeSeparator),
  ...
  function pi(e) {
    ...
    return (
      (e = ki({ timeZone: So.timeZone, calendarSystem: "gregory" }, e, {
        locale: t,
      })),
      new ko(e)
    );
        ...
        "function" == typeof f.columnHeaderHtml
          ...
          : Dn(
              "function" == typeof f.columnHeaderText
                ? f.columnHeaderText(c.toDate(e))
                : c.format(e, i)
            )),
      n ? (h = h.concat(Gn(e, t, o, !0))) : h.push("fc-" + Ri[e.getUTCDay()]),
      '<th class="' +
        h.join(" ") +
        '"' +
        (p && n
        ...
        (s ? " " + s : "") +
        ">" +
        (p ? Yn(l, { date: e, forceOff: !n || 1 === r }, u) : u) +
        "</th>"
    );
  }
  function yi(e, t) {
  ...
  var mi = { className: !0, colSpan: !0, rowSpan: !0 },
    Ei = { "<tr": "tbody", "<td": "tr" },
    Si =
    ...
    Ui = (function () {
      function e(e) {
        ...
        for (var i in e)
          i in Oi
            ? ((n[i] = e[i]), (r = Math.max(Oi[i], r)))
            : ((t[i] = e[i]), i in _i && (r = Math.max(_i[i], r)));
        (this.standardDateProps = t),
          (this.extendedSettings = n),
          (this.severity = r),
          (this.buildFormattingFunc = kt(_t));
      }
      return (
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in ji);
            ...
            "function" == typeof Zi[e] && (t = Zi[e](t)),
              this.mutate({ standardProps: ((n = {}), (n[e] = t), n) });
          else if (e in Fi) {
            var i = void 0;
            "function" == typeof Fi[e] && (t = Fi[e](t)),
              "color" === e
        ...
        (e.prototype.setStart = function (e, t) {
          ...
          if (r && this._instance) {
            ...
            if (t.maintainDuration) {
              a = ve(
                $e(i.start, i.end, n, t.granularity),
                $e(r, i.end, n, t.granularity)
              );
            }
        ...
        (e.prototype.setDates = function (e, t, n) {
          ...
          if (a && (null == t || (r = i.createMarker(t))) && this._instance) {
            ...
            if (r) {
              ...
              (o.hasEnd = !1), this.mutate({ startDelta: u, standardProps: o });
          }
        }),
        ...
        Object.defineProperty(e.prototype, "source", {
          get: function () {
            ...
            return e
              ? new Vi(this._calendar, this._calendar.state.eventSources[e])
              : null;
          },
          enumerable: !0,
          configurable: !0,
    ...
    ji = { start: null, date: null, end: null, allDay: null },
    Yi = 0,
    qi = {
      startTime: "09:00",
      endTime: "17:00",
    ...
    Xi = (function () {
      function e() {
        (this.getKeysForEventDefs = kt(this._getKeysForEventDefs)),
          (this.splitDateSelection = kt(this._splitDateSpan)),
          (this.splitEventStore = kt(this._splitEventStore)),
          (this.splitIndividualUi = kt(this._splitIndividualUi)),
          (this.splitEventDrag = kt(this._splitInteraction)),
          (this.splitEventResize = kt(this._splitInteraction)),
    ...
    Ki = (function (e) {
      ...
      return (
        ...
        (t.prototype.off = function (e, t) {
          return (
            this._handlers && Kn(this._handlers, e, t),
            this._oneHandlers && Kn(this._oneHandlers, e, t),
            this
          );
        }),
        ...
        (t.prototype.triggerWith = function (e, t, n) {
          return (
            this._handlers && je(this._handlers[e], t, n),
            this._oneHandlers &&
              (je(this._oneHandlers[e], t, n), delete this._oneHandlers[e]),
            this
          );
        }),
            ...
            "auto" === n &&
              (n =
                e.left || e.right || this.canScrollVertically()
                  ? "scroll"
                  : "hidden"),
            g(this.el, { overflowX: t, overflowY: n });
        }),
  ...
  (ro.prototype.classes = {}),
    (ro.prototype.iconClasses = {}),
    (ro.prototype.baseIconClass = ""),
    (ro.prototype.iconOverridePrefix = "");
  var io = 0,
    oo = (function () {
      function e(e, t) {
        t && (e.view = this),
      ...
      return (
        (e.addEqualityFuncs = function (e) {
          this.prototype.equalityFuncs = ki(
            {},
  ...
  (ao.prototype.fgSegSelector = ".fc-event-container > *"),
    (ao.prototype.bgSegSelector = ".fc-bgevent:not(.fc-nonbusiness)");
  var so = 0,
    uo = (function () {
      function e() {
        (this.hooks = {
      ...
      parse: function (e, t, n) {
        ...
        return a
          ? {
              ...
              duration:
                o.startTime && o.endTime ? ve(o.endTime, o.startTime) : null,
              typeData: o,
            }
          : null;
      },
      expand: function (e, t, n) {
        var r = bt(t, { start: e.startRecur, end: e.endRecur });
        return r ? or(e.daysOfWeek, e.startTime, r, n) : [];
      },
    },
    yo = $n({ recurringTypes: [go] }),
    mo = $n({
      optionChangeHandlers: {
        events: function (e, t) {
          ar([e], t);
  ...
  var Mo =
    ...
    ko = (function () {
      function e(e) {
        ...
        e.namedTimeZoneImpl &&
          ...
          (this.calendarSystem = vr(e.calendarSystem)),
      ...
      return (
        ...
        (e.prototype.diffWholeMonths = function (e, t) {
          var n = this.calendarSystem;
          return se(e) === se(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
            ? n.getMarkerMonth(t) -
                n.getMarkerMonth(e) +
      ...
      return (
        ...
        (e.prototype.build = function (e, t, n) {
          ...
          return (
            ...
            (s = a),
            this.options.showNonCurrentDates || (s = bt(s, i.range)),
            (l = ue(this.options.minTime)),
            (c = ue(this.options.maxTime)),
            (s = this.adjustActiveRange(s, l, c)),
            (s = bt(s, r)),
            (u = Tt(i.range, r)),
            {
              validRange: r,
        ...
        (e.prototype.buildCurrentRangeInfo = function (e, t) {
          ...
          return (
            i.duration
              ? ((a = i.duration),
                (s = i.durationUnit),
                (u = this.buildRangeFromDuration(e, t, a, s)))
              : (n = this.options.dayCount)
              ? ((s = "day"), (u = this.buildRangeFromDayCount(e, t, n)))
              : (u = this.buildCustomVisibleRange(e))
              ? (s = o.greatestWholeUnit(u.start, u.end).unit)
              : ((a = this.getFallbackDuration()),
                (s = we(a).unit),
                (u = this.buildRangeFromDuration(e, t, a, s))),
            { duration: a, unit: s, range: u }
          );
        }),
        ...
        (e.prototype.adjustActiveRange = function (e, t, n) {
          ...
          return (
            this.viewSpec.class.prototype.usesMinMaxTime &&
              (Ee(t) < 0 && ((i = X(i)), (i = r.add(i, t))),
              Ee(n) > 1 && ((o = X(o)), (o = A(o, -1)), (o = r.add(o, n)))),
            { start: i, end: o }
          );
        }),
        (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
          ...
          return (
            d ||
              ((o = this.options.dateIncrement),
              o
                ? ((a = ue(o)), (d = De(a) < De(n) ? we(a, !de(o)).unit : r))
                : (d = r)),
            Ee(n) <= 1 &&
              this.isHiddenDay(s) &&
              ((s = this.skipHiddenDays(s, t)), (s = X(s))),
            i(),
            this.trimHiddenDays(l) || ((e = this.skipHiddenDays(e, t)), i()),
            l
          );
        }),
    ...
    xo = { start: null, end: null, allDay: Boolean },
    No = { type: String, class: null },
    zo = (function (e) {
      function r(n, r) {
        var i = e.call(this, n) || this;
        return (
          (i._renderLayout = An(i.renderLayout, i.unrenderLayout)),
          (i._updateTitle = An(i.updateTitle, null, [i._renderLayout])),
          (i._updateActiveButton = An(i.updateActiveButton, null, [
            i._renderLayout,
          ])),
          (i._updateToday = An(i.updateToday, null, [i._renderLayout])),
          (i._updatePrev = An(i.updatePrev, null, [i._renderLayout])),
          (i._updateNext = An(i.updateNext, null, [i._renderLayout])),
          (i.el = t("div", { className: "fc-toolbar " + r })),
          i
        );
      }
      return (
                    ...
                    "title" === e
                      ...
                      : ((r = f[e])
                          ? ((d = function (e) {
                            ...
                            (v = s.getCustomButtonIconClass(r)) ||
                              (v = s.getIconClass(e)) ||
                              (g = r.text))
                          : (a = c[e])
                          ? (i.viewsWithButtons.push(e),
                            (d = function () {
                              u.changeView(e);
                            }),
                          ...
                          : u[e] &&
                            ...
                            (g = p[e]) ||
                              ...
                              (g = h[e])),
                        d &&
                          ((m = ["fc-" + e + "-button", s.getClass("button")]),
                          g
                            ? ((y = Dn(g)), (S = ""))
                            : v &&
                              ((y = "<span class='" + v + "'></span>"),
    ...
    Uo = (function (e) {
      function n(n, r) {
        var i = e.call(this, n) || this;
        (i._renderToolbars = An(i.renderToolbars)),
          (i.buildViewPropTransformers = kt(ni)),
          (i.el = r),
          s(r, (i.contentEl = t("div", { className: "fc-view-container" })));
        for (
          var o = i.calendar,
            a = 0,
            u = o.pluginSystem.hooks.viewContainerModifiers;
          a < u.length;
          a++
        ) {
          (0, u[a])(i.contentEl, o);
        ...
        return (
          ...
          (i.computeTitle = kt(ei)),
          (i.parseBusinessHours = kt(function (e) {
      ...
      return (
        ...
        (n.prototype.renderToolbars = function (e, t, n, r, i) {
          ...
          o
            ? (this.header ||
                ((this.header = new zo(this.context, "fc-header-toolbar")),
                s(this.el, this.header.el)),
              this.header.receiveProps(ki({ layout: o }, p)))
            : this.header && (this.header.destroy(), (this.header = null)),
            u
              ? (this.footer ||
                  ((this.footer = new zo(this.context, "fc-footer-toolbar")),
                  a(this.el, this.footer.el)),
                this.footer.receiveProps(ki({ layout: u }, p)))
        ...
        (n.prototype.queryToolbarsHeight = function () {
          var e = 0;
          return (
            this.header && (e += _(this.header.el)),
            this.footer && (e += _(this.footer.el)),
            e
          );
        }),
    ...
    Bo = (function (e) {
      function t(t) {
        ...
        var r = t.component;
        return (
          (n.removeHoverListeners = z(
            r.el,
            r.fgSegSelector + "," + r.bgSegSelector,
            n.handleSegEnter,
            n.handleSegLeave
          )),
          r.calendar.on("eventElRemove", n.handleEventElRemove),
          n
        );
      }
      return (
  ...
  var Wo = (function () {
    function e(e, t) {
      var n = this;
      (this.parseRawLocales = kt(cr)),
        (this.buildLocale = kt(dr)),
        (this.buildDateEnv = kt(oi)),
        (this.buildTheme = kt(ai)),
        (this.buildEventUiSingleBase = kt(this._buildEventUiSingleBase)),
        (this.buildSelectionConfig = kt(this._buildSelectionConfig)),
        (this.buildEventUiBySource = Ot(ui, Fn)),
        (this.buildEventUiBases = kt(li)),
        ...
        (this.buildDelayedRerender = kt(si)),
        (this.afterSizingTriggers = {}),
        (this.isViewUpdated = !1),
        (this.isDatesUpdated = !1),
        (this.isEventsUpdated = !1),
        (this.el = e),
        (this.optionsManager = new Ro(t || {})),
        (this.pluginSystem = new uo()),
    ...
    return (
      ...
      (e.prototype.renderComponent = function (e) {
        ...
        var s = (this.renderableEventStore =
            n.eventSourceLoadingLevel && !this.opt("progressiveEventRendering")
      ...
      (e.prototype.processOptions = function (e, t) {
        var n = this,
          ...
          a = !1;
        for (var s in e)
          /^(height|contentHeight|aspectRatio)$/.test(s)
            ? (o = !0)
            : /^(defaultDate|defaultView)$/.test(s) ||
              ((a = !0), "timeZone" === s && (i = !0));
        "reset" === t
          ? ((a = !0), this.optionsManager.reset(e))
          : "dynamic" === t
          ? this.optionsManager.addDynamic(e)
          : this.optionsManager.add(e),
          a &&
            (this.handleOptions(this.optionsManager.computed),
            (this.needsFullRerender = !0),
            this.batchRendering(function () {
              i && n.dispatch({ type: "CHANGE_TIMEZONE", oldDateEnv: r }),
                n.dispatch({
                  type: "SET_VIEW_TYPE",
      ...
      (e.prototype.handleOptions = function (e) {
        ...
        (this.defaultAllDayEventDuration = ue(e.defaultAllDayEventDuration)),
          (this.defaultTimedEventDuration = ue(e.defaultTimedEventDuration)),
        ...
        (this.dateEnv = this.buildDateEnv(
          ...
          (this.viewSpecs = Qr(n.views, this.optionsManager)),
          (this.dateProfileGenerators = ot(this.viewSpecs, function (e) {
      ...
      (e.prototype._buildEventUiSingleBase = function (e) {
        return (
          e.editable && (e = ki({}, e, { eventEditable: !0 })),
          Cn("event", e, this)
        );
      }),
      ...
      (e.prototype.changeView = function (e, t) {
        ...
        t &&
          (t.start && t.end
            ? (this.optionsManager.addDynamic({ visibleRange: t }),
              this.handleOptions(this.optionsManager.computed))
      ...
      (e.prototype.getUnitViewSpec = function (e) {
        var t,
          ...
          r = this.component,
          i = [];
        r.header && i.push.apply(i, r.header.viewsWithButtons),
      ...
      (e.prototype.formatRange = function (e, t, n) {
        ...
        return r.formatRange(
          r.createMarker(e),
          r.createMarker(t),
          Vt(n, this.opt("defaultRangeSeparator")),
          n
        );
      }),
      (e.prototype.formatIso = function (e, t) {
        ...
        n =
          null == t
            ? null != e.start
              ...
              : { start: e, end: null }
            : { start: e, end: t };
        var r = Ar(n, this.dateEnv, ue({ days: 1 }));
        r &&
      ...
      (e.prototype.buildDatePointApi = function (e) {
        for (
          var t = {}, n = 0, r = this.pluginSystem.hooks.datePointTransforms;
          n < r.length;
          n++
        ) {
          var i = r[n];
      ...
      (e.prototype.buildDateSpanApi = function (e) {
        for (
          var t = {}, n = 0, r = this.pluginSystem.hooks.dateSpanTransforms;
          n < r.length;
          n++
        ) {
          var i = r[n];
      ...
      (e.prototype.addEvent = function (e, t) {
        if (e instanceof Bi) {
          ...
          return (
            this.state.eventStore.defs[n.defId] ||
              this.dispatch({
                type: "ADD_EVENTS",
                eventStore: lt({ def: n, instance: r }),
              }),
            e
          );
        }
        ...
        var a = On(e, i, this);
        return a
          ? (this.dispatch({ type: "ADD_EVENTS", eventStore: lt(a) }),
            new Bi(this, a.def, a.def.recurringDef ? null : a.instance))
          : null;
      }),
      ...
      (e.prototype.getEventSourceById = function (e) {
        ...
        e = String(e);
        for (var n in t) if (t[n].publicId === e) return new Vi(this, t[n]);
        return null;
      }),
  ...
  var Zo = (function (e) {
    function n(n, r, i, o) {
      var a =
        e.call(
          this,
          n,
          t("div", { className: "fc-view fc-" + r.type + "-view" }),
          !0
        ) || this;
      return (
        (a.renderDatesMem = An(a.renderDatesWrap, a.unrenderDatesWrap)),
        (a.renderBusinessHoursMem = An(
          a.renderBusinessHours,
          a.unrenderBusinessHours,
          [a.renderDatesMem]
        )),
        (a.renderDateSelectionMem = An(
          a.renderDateSelectionWrap,
          a.unrenderDateSelectionWrap,
          [a.renderDatesMem]
        )),
        (a.renderEventsMem = An(a.renderEvents, a.unrenderEvents, [
          a.renderDatesMem,
        ])),
        (a.renderEventSelectionMem = An(
          a.renderEventSelectionWrap,
          a.unrenderEventSelectionWrap,
          [a.renderEventsMem]
        )),
        (a.renderEventDragMem = An(
          a.renderEventDragWrap,
          a.unrenderEventDragWrap,
          [a.renderDatesMem]
        )),
        (a.renderEventResizeMem = An(
        ...
        (a.type = r.type),
        (a.eventOrderSpecs = Ue(a.opt("eventOrder"))),
        (a.nextDayThreshold = ue(a.opt("nextDayThreshold"))),
        o.appendChild(a.el),
        a.initialize(),
        a
      );
    ...
    return (
      ...
      (n.prototype.renderDatesWrap = function (e) {
        this.renderDates(e),
          this.addScroll({ timeMs: ue(this.opt("scrollTime")).milliseconds }),
      ...
      (n.prototype.startNowIndicator = function (e) {
        ...
        this.opt("nowIndicator") &&
          ...
          (r =
            o.add(o.startOf(this.initialNowDate, t), ue(1, t)).valueOf() -
      ...
      (n.prototype.applyScroll = function (e, t) {
        ...
        null != n &&
          (delete e.timeMs,
          this.props.dateProfile && ki(e, this.computeDateScroll(n))),
      ...
      (n.prototype.scrollToTime = function (e) {
  ...
  Ki.mixInto(Zo),
    (Zo.prototype.usesMinMaxTime = !1),
    (Zo.prototype.dateProfileGeneratorClass = Ho);
  var jo = (function () {
      function e(e) {
        ...
        (e.prototype.renderSegEls = function (e, t) {
          ...
          if (t.length) {
            ...
            r(o).forEach(function (e, n) {
              ...
              "bgEvent" === e && (t = Gt(this.context.view, t, !1)),
    ...
    Xo = { startTime: ue, duration: ue, create: Boolean, sourceId: String },
    Jo = { create: !0 },
    Ko = (function (e) {
      function t(t, r) {
        ...
        return (
          ...
          r.appendChild(
            (i.el = n(
              '<div class="fc-row ' +
                i.theme.getClass("headerRow") +
                '"><table class="' +
                i.theme.getClass("tableGrid") +
                '"><thead></thead></table></div>'
            ))
          ),
          (i.thead = i.el.querySelector("thead")),
          i
        );
      }
      return (
        ...
        (t.prototype.render = function (e) {
          ...
          for (
            var i = Vt(this.opt("columnHeaderFormat") || vi(n, t.length)),
              o = 0,
              a = t;
            o < a.length;
            o++
    ...
    ea = (function () {
      function e() {
        (this.sliceBusinessHours = kt(this._sliceBusinessHours)),
          (this.sliceDateSelection = kt(this._sliceDateSpan)),
          (this.sliceEventStore = kt(this._sliceEventStore)),
      ...
      return (
        ...
        (e.prototype.sliceNowDate = function (e, t) {
          ...
          return this._sliceDateSpan.apply(
            this,
            [{ range: { start: e, end: V(e, 1) }, allDay: !1 }, {}, t].concat(n)
          );
        }),
        (e.prototype._sliceBusinessHours = function (e, t, n, r) {
          ...
          return e
            ? this._sliceEventStore.apply(
                this,
                [ct(e, yi(t, Boolean(n)), r.calendar), {}, t, n, r].concat(i)
              ).bg
            : [];
        }),
  ...
  (e.Calendar = Wo),
    ...
    (e.DateComponent = ao),
    (e.DateEnv = ko),
    (e.DateProfileGenerator = Ho),
    (e.DayHeader = Ko),
    (e.DaySeries = Qo),
    (e.DayTable = $o),
    (e.ElementDragging = Go),
    (e.ElementScrollController = eo),
    (e.EmitterMixin = Ki),
    (e.EventApi = Bi),
    (e.FgEventRenderer = jo),
    (e.FillRenderer = Yo),
    (e.Interaction = Lo),
    (e.Mixin = Ji),
    (e.NamedTimeZoneImpl = qo),
    (e.PositionCache = Qi),
    (e.ScrollComponent = no),
    (e.ScrollController = $i),
    (e.Slicer = ea),
    (e.Splitter = Xi),
    (e.Theme = ro),
    (e.View = Zo),
    (e.WindowScrollController = to),
    (e.addDays = A),
    (e.addDurations = he),
    (e.addMs = V),
    (e.addWeeks = L),
    ...
    (e.appendToElement = a),
    (e.applyAll = je),
    (e.applyMutationToEventStore = $t),
    (e.applyStyle = g),
    (e.applyStyleProp = y),
    (e.asRoughMinutes = Se),
    (e.asRoughMs = De),
    (e.asRoughSeconds = be),
    (e.buildGotoAnchorHtml = Yn),
    (e.buildSegCompareObj = ci),
    (e.capitaliseFirstLetter = Be),
    (e.combineEventUis = Mn),
    (e.compareByFieldSpec = Ae),
    (e.compareByFieldSpecs = Le),
    (e.compareNumbers = We),
    (e.compensateScroll = Re),
    (e.computeClippingRect = H),
    (e.computeEdges = C),
    (e.computeFallbackHeaderFormat = vi),
    (e.computeHeightAndMargins = _),
    (e.computeInnerRect = M),
    (e.computeRect = k),
    (e.computeVisibleDayRange = Ke),
    (e.config = Eo),
    (e.constrainPoint = b),
    (e.createDuration = ue),
    (e.createElement = t),
    (e.createEmptyEventStore = vt),
    (e.createEventInstance = Pn),
    (e.createFormatter = Vt),
    (e.createPlugin = $n),
    (e.cssToStr = Tn),
    (e.debounce = qe),
    (e.diffDates = $e),
    ...
    (e.diffWholeWeeks = q),
    (e.disableCursor = Ce),
    (e.distributeHeight = ke),
    (e.elementClosest = d),
    (e.elementMatches = f),
    (e.enableCursor = Me),
    (e.eventTupleToStore = lt),
    (e.filterEventStoreDefs = yt),
    (e.filterHash = it),
    (e.findChildren = h),
    (e.findElements = p),
    (e.flexibleCompare = Ve),
    (e.forceClassName = v),
    (e.formatDate = di),
    (e.formatIsoTimeString = Ft),
    (e.formatRange = fi),
    (e.freezeRaw = Xe),
    (e.getAllDayHtml = qn),
    (e.getClippingParents = P),
    (e.getDayClasses = Gn),
    (e.getElSeg = Jt),
    (e.getRectCenter = D),
    (e.getRelevantEvents = dt),
    (e.globalDefaults = So),
    (e.greatestDurationDenominator = we),
    (e.hasBgRendering = qt),
    (e.htmlEscape = Dn),
    (e.htmlToElement = n),
    (e.insertAfterElement = u),
    (e.interactionSettingsStore = Ao),
    (e.interactionSettingsToStore = ii),
    (e.intersectRanges = bt),
    (e.intersectRects = E),
    (e.isArraysEqual = Mt),
    (e.isDateSpansEqual = Br),
    (e.isInt = Ze),
    (e.isInteractionValid = dn),
    (e.isMultiDayRange = Qe),
    (e.isObjectsSimilar = Fn),
    (e.isPropsValid = hn),
    (e.isSingleDay = pe),
    (e.isValidDate = ae),
    (e.isValuesSimilar = Vn),
    (e.listenBySelector = N),
    (e.mapHash = ot),
    (e.matchCellWidths = _e),
    (e.memoize = kt),
    (e.memoizeOutput = Ot),
    (e.memoizeRendering = An),
    (e.mergeEventStores = gt),
    (e.multiplyDuration = ge),
    (e.padStart = Fe),
    (e.parseBusinessHours = Un),
    (e.parseDragMeta = hi),
    (e.parseEventDef = _n),
    (e.parseFieldSpecs = Ue),
    (e.parseMarker = gr),
    (e.pointInsideRect = m),
    (e.prependToElement = s),
    (e.preventContextMenu = Ne),
    (e.preventDefault = x),
    (e.preventSelection = He),
    (e.processScopedUiProps = Cn),
    (e.rangeContainsMarker = Rt),
    (e.rangeContainsRange = wt),
    (e.rangesEqual = Dt),
    (e.rangesIntersect = Tt),
    (e.refineProps = Ge),
    (e.removeElement = c),
    (e.removeExact = Ct),
    (e.renderDateCell = gi),
    (e.requestJson = tr),
    (e.sliceEventStore = Yt),
    (e.startOfDay = X),
    (e.subtractInnerElHeight = Pe),
    (e.translateRect = S),
    (e.uncompensateScroll = Ie),
    (e.undistributeHeight = Oe),
    (e.unpromisify = Xn),
    (e.version = "4.1.0"),
    (e.whenTransitionDone = U),
    (e.wholeDivideDurations = Te),
